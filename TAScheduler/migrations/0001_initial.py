# Generated by Django 5.1.2 on 2024-11-27 00:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_of_sections', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            name='Lab',
            fields=[
                ('section_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='TAScheduler.section')),
                ('ta', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assigned_labs', to='TAScheduler.ta')),
            ],
            bases=('TAScheduler.section',),
        ),
        migrations.CreateModel(
            name='Lecture',
            fields=[
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('instructor', 'course'), name='unique_instructor_course')],
            },
        ),
    ]
